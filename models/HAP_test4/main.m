function output_vars = main
  ...
  function [dphidt, extra_output] = f(t, phi) 
    n.value(N_E_93,S_E_93) = reshape(phi(1:2), 1,2);
    ...
    N_E_30 = [2];
    S_E_30 = [1,2];
    m(N_E_30) = E_30(Mm, n, N_E_30, S_E_30);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    N_E_95 = [2];
    S_E_95 = [1,2];
    Axy(N_E_95) = E_95(pi, oneHalf, d_x, N_E_95, S_E_95);
...
function sol = sys1(rho, V, m)
  ...
  function F = sys(x)
    N_E_92 = [2];
    S_E_92 = [1,2];
    V.value(N_E_92,S_E_92) = x(1:1);

    F(1:1) = res_E_97(rho, V, m, N_E_92, S_E_92);
  endfunction
endfunction
...
function sol = E_95(pi, oneHalf, d_x, N, S)
